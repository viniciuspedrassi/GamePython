...
class Score:
    ...
    def save(self, menu_option: str, player_score: list[int]):
        ...
        while True:
            ...
            if menu_option == MENU_OPTION[0]:
                ...
                text = 'Player 1 - Enter with your name: '
            if menu_option == MENU_OPTION[1]:
                score = (player_score[0] + player_score[1]) / 2
                text = 'Enter with the Teams name: '
            if menu_option == MENU_OPTION[2]:
                if player_score[0] >= player_score[1]:
                    ...
                    text = 'Player 2 - Enter with your name: '
            self.score_text(34, text, C_WHITE, SCORE_POS['EnterName'])
    ...
    def show(self):
        ...
        #  Label
        self.score_text(28, 'NAME     SCORE          DATE',C_YELLOW, SCORE_POS['Label'])
        #  Score
        db_proxy = DBProxy('DBScore')
