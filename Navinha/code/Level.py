...
from code.Const import C_WHITE, C_YELLOW, MENU_OPTION, EVENT_ENEMY, WIN_HEIGHT, WIN_WIDTH, C_DARKGREY, C_CYAN
...
class Level:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.level_text(18, f'{clock.get_fps():.0f} fps', C_YELLOW, (10, WIN_HEIGHT - 20))
